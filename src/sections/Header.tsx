              ...
              <nav className="h-full">
                {navItems.map(({ name, href }) => (
                  <Scroll
                    ...
                    smooth={true}
                    duration={1000}
                    className="relative inline-flex h-full cursor-pointer items-center px-10 text-xs font-bold uppercase tracking-widest text-gray-400 before:absolute before:bottom-0 before:left-0 before:h-2 before:w-px before:bg-gray-200/20 before:content-[''] last:after:absolute last:after:bottom-0 last:after:left-0 last:after:right-0 last:after:h-2 last:after:w-px last:after:bg-gray-200/20"
                  >
                    {name}
                  </Scroll>
                ))}
              ...
              {navItems.map(({ name, href }) => (
                ...
                >
                  <button
                    ...
                    className="h-10 cursor-pointer text-xs font-bold uppercase tracking-widest text-gray-400"
                  >
                    {name}
                  </button>
                </Scroll>
